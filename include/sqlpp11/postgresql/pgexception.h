...
namespace sqlpp
{
  namespace postgresql
  {
    ...
    {
    public:
      pg_error_message(PGresult* res) : pg_error_message(PQresultErrorMessage(res))
      {
      }

      pg_error_message(const char* mes) : m_message(mes)
      {
      }
    ...
    public:
      ...
      {
        static constexpr auto warnings = {"01", "02"};
    ...
    {
    public:
      pg_error_code() : pg_error_code("00000")
      {
      }

      pg_error_code(PGresult* res) : pg_error_code("00000")
      {
      ...
      pg_error_class pgClass() const
      {
        return m_class;
      }

    protected:
      pg_error_code(const char* code) : m_class(code), m_code(code)
      {
      }
    ...
    {
    public:
      pg_exception(PGresult* res) : exception(PQresultErrorMessage(res)), m_message(res), m_code(res)
      {
      }
      ...
      const pg_error_message& message() const
      {
        return m_message;
      }
