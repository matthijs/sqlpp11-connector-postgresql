		...
		struct C_bool {
			struct _alias_t {
				...
				template<typename T>
					struct _member_t {
						T c_bool;
						T &operator()() { return c_bool; }
						const T &operator()() const { return c_bool; }
					};
			};
		...
		struct C_timepoint {
			struct _alias_t {
				...
				template<typename T>
					struct _member_t {
						T c_timepoint;
						T &operator()() { return c_timepoint; }
						const T &operator()() const { return c_timepoint; }
					};
			};
		...
		struct C_day {
			struct _alias_t {
				...
				template<typename T>
					struct _member_t {
						T c_day;
						T &operator()() { return c_day; }
						const T &operator()() const { return c_day; }
					};
			};
